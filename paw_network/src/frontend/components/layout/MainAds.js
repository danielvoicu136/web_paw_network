...
function MainAds() { 
    return (
        <div className={classes['ads-container']}>
            <div className={classes['small-box-1']}><p><span className={classes.accentText}>Unlimited</span> services for your <span className={classes.accentText}>all pets</span></p></div>
